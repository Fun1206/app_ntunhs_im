...
class backbody_female : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoxes = listOf(
            findViewById<CheckBox>(R.id.head_f2),
            findViewById<CheckBox>(R.id.neck_f2),
            findViewById<CheckBox>(R.id.back_f),
            findViewById<CheckBox>(R.id.waist_f),
            findViewById<CheckBox>(R.id.Buttocks_f),
            findViewById<CheckBox>(R.id.legs_f2),
            findViewById<CheckBox>(R.id.feet_f2),
            findViewById<CheckBox>(R.id.whole_body_f2),
            findViewById<CheckBox>(R.id.hand_f2),
            findViewById<CheckBox>(R.id.skin_f2),
            findViewById<CheckBox>(R.id.psychology_f2)
        )

        val checkBoxKeyMap = mapOf(
            R.id.head_f2 to "head",
            R.id.neck_f2 to "neck",
            R.id.back_f to "back",
            R.id.waist_f to "waist",
            R.id.Buttocks_f to "Buttocks",
            R.id.legs_f2 to "legs",
            R.id.feet_f2 to "feet",
            R.id.whole_body_f2 to "whole_body",
            R.id.hand_f2 to "hand",
            R.id.skin_f2 to "skin",
            R.id.psychology_f2 to "psychology"
        )
        ...
        frontBtn.setOnClickListener {
            val frontFemaleIntent = Intent(this, frontbody_female::class.java)
