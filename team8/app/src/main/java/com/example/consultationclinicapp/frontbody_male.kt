...
class frontbody_male : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoxes = listOf(
            ...
            findViewById<CheckBox>(R.id.neck_1),
            ...
            findViewById<CheckBox>(R.id.feet_1),
        ...
        val checkBoxKeyMap = mapOf(
            ...
            R.id.neck_1 to "neck",
            R.id.chest to "chest",
            R.id.abdomen to "abdomen",
            R.id.lower_abdomen to "lower_abdomen",
            R.id.legs_1 to "legs",
            R.id.feet_1 to "feet",
            R.id.whole_body_1 to "whole_body",
            R.id.hand_1 to "hand",
            R.id.skin_1 to "skin",
            R.id.psychology_1 to "psychology"
        )
        ...
        backBtn.setOnClickListener {
            val backMaleIntent = Intent(this, backbody_male::class.java)
